            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <div className="flex items-center gap-2 text-indigo-500 mb-2">
                        ...
                        <span className="text-sm font-bold uppercase tracking-wider">Compliance & Governance</span>
                    </div>
                    <h1 className="text-3xl font-black tracking-tight text-white">Placement Policy Engine</h1>
                    <p className="text-gray-400 mt-1">Configure automated rules for eligibility, offers, and company classifications.</p>
                </div>
                <div className="flex items-center gap-3">
                    <Link href="/university" className="px-4 py-2 rounded-xl border border-white/5 hover:bg-white/5 text-gray-400 transition-all flex items-center gap-2">
                        <ArrowLeft className="w-4 h-4" /> Back to Dashboard
                    </Link>
                    <button
                        onClick={handleSave}
                        disabled={saving}
                        className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-indigo-500 to-violet-600 text-white font-bold hover:opacity-90 transition-all shadow-lg shadow-indigo-500/20 flex items-center gap-2 disabled:opacity-50"
                    >
