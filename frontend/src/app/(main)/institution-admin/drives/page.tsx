// src/app/(main)/institution-admin/drives/page.tsx
"use client";
...
export default function PlacementDrivesPage() {
    ...
    const loadDrives = async () => {
        setLoading(true);
        try {
            const res = await authFetch('/institution-admin/drives');
            if (res.ok) {
        ...
        <div className="space-y-6 max-w-7xl mx-auto pb-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 ml-11">Manage institutional hiring events and company visits.</p>
                </div>
                <button
                    ...
                    {drives.map((drive, idx) => (
                        ...
                        >
                            <div className="p-6">
                                ...
                                <Link
                                    href={`/institution-admin/drives/${drive.id}`}
