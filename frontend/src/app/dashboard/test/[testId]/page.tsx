...
export default function TestPage({ params }: { params: { testId: string } }) {
    ...
    const startTestSession = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3000/api/v1'}/validation/tests/${params.testId}/start`, {
                method: 'POST',
                headers: {
    ...
    const submitTest = async () => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3000/api/v1'}/validation/tests/${params.testId}/submit`, {
                method: 'POST',
                headers: {
