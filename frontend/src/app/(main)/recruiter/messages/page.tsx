                ...
                <div className="p-4 border-b border-gray-200 dark:border-white/5">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg pl-9 pr-4 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-blue-500"
                        />
                    </div>
                </div>
                    ...
                    {loadingConversations ? (
                        ...
                        conversations.map(chat => (
                            <button
                                ...
                                className={`w-full flex items-center gap-3 p-4 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors text-left ${activeChat?.id === chat.id ? "bg-white/5 border-l-2 border-blue-500" : ""}`}
                            >
                    ...
                    <>
                        ...
                        <div className="p-4 border-b border-gray-200 dark:border-white/5 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                <button className="p-2 hover:bg-gray-50 dark:hover:bg-white/5 rounded-lg text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                                    ...
                                    return (
                                        <div key={msg.id} className={`flex ${isMe ? "justify-end" : "justify-start"}`}>
                                            <div className={`max-w-[70%] rounded-2xl px-4 py-3 ${isMe
                                                ...
                                                <p>{msg.content}</p>
                                                <span className={`text-xs mt-1 block ${isMe ? "text-blue-200" : "text-gray-500 dark:text-gray-400"}`}>
                        ...
                        <div className="p-4 border-t border-gray-200 dark:border-white/5">
                            ...
                            >
                                <input
                                    ...
                                    className="flex-1 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg px-4 py-2.5 text-gray-900 dark:text-white focus:outline-none focus:border-blue-500"
                                />
                                <button
                                    type="submit"
