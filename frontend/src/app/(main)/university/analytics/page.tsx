        ...
        <div className="space-y-8 pb-12">
            <div className="flex justify-between items-end">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Deep insights into institutional hiring performance and trends.</p>
                </div>
                <button className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-2 hover:bg-gray-50 transition">
