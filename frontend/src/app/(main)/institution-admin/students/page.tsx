// src/app/(main)/institution-admin/students/page.tsx
"use client";
...
function ImportStudentsModal({ isOpen, onClose, onSuccess }: ImportModalProps) {
        ...
        Papa.parse(file, {
            ...
            complete: async (results) => {
                try {
                    ...
                    const res = await authFetch('/institution-admin/students/bulk-import', {
                        method: 'POST',
                        headers: {
    ...
    const downloadSample = () => {
        const csvContent = "data:text/csv;charset=utf-8,name,email,branch,department,cgpa,graduationYear,backlogs,skills\nJohn Doe,john@example.com,Computer Science,CSE,8.5,2025,0,\"React, Node.js, Python\"";
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
                ...
                <p className="text-sm text-gray-500 mb-6 font-medium">Upload a CSV file with student details (Name, Email, Branch, Department, CGPA, Year, Backlogs, Skills).</p>
        ...
        <div className="space-y-10 max-w-7xl mx-auto pb-20">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 ml-11">Real-time talent monitoring and AI-driven placement readiness assessments.</p>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 text-white text-sm font-bold shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/30 transition"
                    >
                        Bulk Import
                    </button>
                </div>
                                    ...
                                    >
                                        ...
                                        <td className="px-8 py-6 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <button
                                                    onClick={() => {
                                                        const targetPath = `/institution-admin/messages?candidateId=${student.id}`;
                                                        if (pathname === '/institution-admin/messages' && searchParams.get('candidateId') === student.id) {
                                                            router.back();
                                                        } else {
                                                            router.push(targetPath);
                                                        }
                                                    }}
                                                    className="inline-flex items-center gap-2 px-4 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-500/20 hover:bg-emerald-100 transition-all active:scale-95 group"
                                                >
