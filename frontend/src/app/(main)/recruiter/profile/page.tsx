    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-1">Manage your company information and branding</p>
            </div>

            <div className="glass rounded-xl p-6 lg:p-8 space-y-6">
                {/* Logo Section */}
                <div className="flex items-center gap-6 pb-6 border-b border-gray-200 dark:border-white/5">
                    <div className="w-24 h-24 rounded-xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 flex items-center justify-center">
                        <Building className="w-10 h-10 text-gray-500 dark:text-gray-400" />
                    </div>
                    <div>
                        <button className="px-4 py-2 bg-gray-100 dark:bg-white/10 hover:bg-gray-300 dark:hover:bg-white/20 text-gray-900 dark:text-white rounded-lg text-sm font-medium transition-colors">
                            Upload Logo
                        </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg pl-9 pr-4 py-2.5 text-gray-900 dark:text-white focus:outline-none focus:border-blue-500"
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-gray-600 dark:text-gray-300">Company Size</label>
                        <div className="relative">
                            <Users className="absolute left-3 top-2.5 w-4 h-4 text-gray-500" />
                            <select
                                value={profile.size}
                                onChange={e => setProfile({ ...profile, size: e.target.value })}
                                className="w-full bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg pl-9 pr-4 py-2.5 text-gray-900 dark:text-white focus:outline-none focus:border-blue-500 [&>option]:text-black"
                            >
                ...
                <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-600 dark:text-gray-300">About Company</label>
                    <textarea
