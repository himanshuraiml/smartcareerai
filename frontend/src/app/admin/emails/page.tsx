...
export default function AdminEmailsPage() {
    ...
    const loadLogs = async () => {
        ...
        const res = await fetch(`${API_URL}/admin/emails/logs?${params}`, {
    ...
    const loadStats = async () => {
        const res = await fetch(`${API_URL}/admin/emails/stats`, {
            headers: { 'Authorization': `Bearer ${accessToken}` }
        });
        if (res.ok) {
            const data = await res.json();
    ...
    const loadInvites = async () => {
        const res = await fetch(`${API_URL}/admin/emails/invites`, {
            headers: { 'Authorization': `Bearer ${accessToken}` }
        });
        if (res.ok) {
            const data = await res.json();
    ...
    const handleSaveTemplate = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const url = editingTemplate
                ? `${API_URL}/admin/emails/templates/${editingTemplate.id}`
                : `${API_URL}/admin/emails/templates`;
    ...
    const handleDeleteTemplate = async (id: string) => {
        ...
        try {
            const res = await fetch(`${API_URL}/admin/emails/templates/${id}`, {
                method: 'DELETE',
                headers: { 'Authorization': `Bearer ${accessToken}` }
            });
    ...
    const handleSendBulkEmail = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch(`${API_URL}/admin/emails/send-bulk`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${accessToken}`
    ...
    const handleSendTestEmail = async () => {
        ...
        try {
            const res = await fetch(`${API_URL}/admin/emails/send-test`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${accessToken}`
