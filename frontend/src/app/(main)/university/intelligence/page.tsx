        ...
        <div className="space-y-10 pb-20">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 font-medium">Predictive analytics and risk assessment engine powered by SmartCareer AI.</p>
                </div>
                <button
                    onClick={handleRecalculate}
                    disabled={calculating}
                    className="group bg-black dark:bg-white text-white dark:text-black px-8 py-4 rounded-3xl font-black text-xs uppercase tracking-widest flex items-center gap-3 transition-all active:scale-95 disabled:opacity-50"
                >
                    <RefreshCw className={`w-4 h-4 ${calculating ? 'animate-spin' : 'group-hover:rotate-180 transition-transform duration-500'}`} />
                    {calculating ? 'Processing Talent...' : 'Sync AI Engine'}
                </button>
            </div>
                                    ...
                                    <tr key={idx} className="hover:bg-gray-50 dark:hover:bg-white/[0.01] transition-colors group">
                                        <td className="px-10 py-6">
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 bg-violet-100 dark:bg-violet-900/30 rounded-xl flex items-center justify-center font-black text-violet-600">
