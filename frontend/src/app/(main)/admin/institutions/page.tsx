                ...
                {showInviteModal && selectedInstitution && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                        ...
                        >
                            <div className="flex items-center justify-between mb-6">
                                <div>
                                    <h2 className="text-xl font-bold text-white">Send Institution Admin Invite</h2>
                                    <p className="text-sm text-gray-400 mt-1">{selectedInstitution.name}</p>
                                </div>
                                <button
                                    onClick={() => {
                                        setShowInviteModal(false);
                            ...
                            <form onSubmit={(e) => {
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2 rounded-lg bg-gray-800 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                    />
                                    <p className="mt-1 text-xs text-gray-400">The admin will receive an email with a link to set up their account</p>
                                </div>
                ...
                {showCredentialsModal && selectedInstitution && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                        ...
                        >
                            <div className="flex items-center justify-between mb-6">
                                <div>
                                    <h2 className="text-xl font-bold text-white">Set Admin Credentials</h2>
                                    <p className="text-sm text-gray-400 mt-1">{selectedInstitution.name}</p>
                                </div>
                                <button
                                    onClick={() => {
                            ...
                            <form onSubmit={handleSetCredentials} className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="admin@institution.edu"
                                        className="w-full px-4 py-2 rounded-lg bg-gray-800 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500"
                                    />
                                </div>
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full px-4 py-2 pr-10 rounded-lg bg-gray-800 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500"
                                        />
                                        <button
                                            type="button"
