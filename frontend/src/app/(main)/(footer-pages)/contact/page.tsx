...
export default function ContactPage() {
    return (
        <div className="min-h-screen bg-[#0B0F19] text-gray-300 py-20 px-4 flex items-center justify-center">
            <div className="max-w-2xl w-full glass-premium p-10 rounded-3xl border-gradient relative overflow-hidden">
                ...
                <p className="text-gray-400 mb-10">Have questions? We'd love to hear from you.</p>
                ...
                <div className="space-y-6">
                    <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
                        ...
                        <div>
                            ...
                            <a href="mailto:support@placenxt.com" className="text-white font-semibold hover:text-indigo-400 transition-colors">support@placenxt.com</a>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
                        ...
                        <div>
                            ...
                            <span className="text-white font-semibold">+91 12345 67890</span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
                        ...
                        <div>
                            ...
                            <span className="text-white font-semibold">Bangalore, India</span>
                        </div>
                    </div>
                </div>
            </div>
