...
PlaceNxt is an AI-powered career platform for early-career students. It's a microservices-based SaaS application using Node.js/Express backend services, Next.js 14 frontend, PostgreSQL with Prisma ORM, and OpenAI GPT-4 for AI features.
