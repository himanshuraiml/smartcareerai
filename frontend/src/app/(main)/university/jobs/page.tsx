// src/app/(main)/university/jobs/page.tsx
"use client";
        ...
        <div className="space-y-6 max-w-7xl mx-auto pb-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Review and approve job listings from recruiters for your students.</p>
                </div>
                                ...
                                <div className="flex justify-between items-start gap-4">
                                    <div className="flex gap-4">
                                        <div className="w-12 h-12 rounded-2xl bg-gray-100 dark:bg-white/5 flex items-center justify-center shrink-0">
                                            {job.recruiter.organization.logoUrl && !failedLogos[job.id] ? (
                                                <div className="relative w-8 h-8 rounded-lg overflow-hidden">
                                                    <Image
                                                        src={job.recruiter.organization.logoUrl}
                                                        alt=""
                                                        fill
                                                        className="object-contain"
                                                        onError={() => setFailedLogos(prev => ({ ...prev, [job.id]: true }))}
                                                    />
                                                </div>
                                            ) : (
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500 font-bold">{job.recruiter.organization.name}</p>
                                        </div>
                                    </div>
                            ...
                            >
                                <div className="mb-8">
                                    ...
                                    <div className="flex items-center gap-2 text-violet-600 dark:text-violet-400 font-bold text-sm mb-6">
                                        ...
                                        {selectedJob.recruiter.organization.name}
                                    </div>
