    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            <motion.div
                ...
                className="w-full max-w-6xl max-h-[90vh] overflow-y-auto bg-[#0F111A] rounded-3xl border border-white/10 shadow-2xl"
            >
                {/* Header */}
                <div className="sticky top-0 z-10 flex items-center justify-between p-6 bg-[#0F111A]/95 border-b border-white/5 backdrop-blur-xl">
                    <div className="flex items-center gap-4">
                        <button onClick={onClose} className="p-2 rounded-xl hover:bg-white/5 transition text-gray-400 hover:text-white">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                        {/* Overall Score Gauge */}
                        <div className="md:col-span-4 lg:col-span-3 bg-gradient-to-br from-indigo-900/20 to-purple-900/20 rounded-3xl p-6 border border-indigo-500/20 relative overflow-hidden flex flex-col items-center justify-center">
                            ...
                            <div className="relative w-48 h-48 flex items-center justify-center">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
                                    ...
                                    <span className="text-sm text-gray-400 uppercase tracking-wider font-medium">Score</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-8 lg:col-span-9 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {/* Keyword Match */}
                            <div className="bg-[#131620] rounded-2xl p-5 border border-white/5 flex flex-col justify-between group hover:border-indigo-500/30 transition-colors">
                                ...
                                <div>
                                    <h4 className="text-gray-300 font-medium mb-1">Keyword Match</h4>
                            ...
                            {/* Formatting */}
                            <div className="bg-[#131620] rounded-2xl p-5 border border-white/5 flex flex-col justify-between group hover:border-purple-500/30 transition-colors">
                                <div className="flex items-start justify-between mb-4">
                                ...
                                <div>
                                    <h4 className="text-gray-300 font-medium mb-1">Formatting Score</h4>
                                    <div className="w-full bg-gray-800 rounded-full h-1.5 overflow-hidden">
                                        <div
                            ...
                            {/* AI Insights */}
                            <div className="sm:col-span-2 bg-gradient-to-r from-gray-900 to-[#131620] rounded-2xl p-5 border border-white/5 flex items-center gap-6">
                                <div className="p-4 rounded-full bg-emerald-500/10 text-emerald-400 shrink-0">
                                    <Cpu className="w-8 h-8" />
                                </div>
                                <div>
                                    <div className="flex items-center gap-2 mb-1">
                                        <h4 className="text-gray-300 font-medium">AI Insight:</h4>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {/* Radar Chart */}
                        <div className="bg-[#131620] rounded-3xl p-6 border border-white/5">
                        ...
                        {/* Skills Analysis */}
                        <div className="bg-[#131620] rounded-3xl p-6 border border-white/5 flex flex-col">
                            <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="bg-[#131620] rounded-3xl p-6 border border-white/5">
                        <div className="flex items-center justify-between mb-6">
                            <h3 className="text-lg font-bold text-white">Improvement Tips</h3>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {data.suggestions && data.suggestions.map((suggestion, i) => (
                                <div key={i} className="flex gap-4 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-indigo-500/30 transition-colors">
                                    <div className="shrink-0 w-10 h-10 rounded-lg bg-indigo-500/10 flex items-center justify-center text-indigo-400">
